...
export default function ITDeclarationItemReviewPanel({
  ...
  return (
    <Paper sx={{ p: 1.1, border: "1px solid #dbe3ef", borderRadius: "10px" }}>
      <Stack spacing={0.8}>
        ...
        <Typography sx={{ color: "#64748b", fontSize: "0.84rem" }}>
          Declared Amount: {objInrFormatter.format(Number(objItem.decDeclaredAmount || 0))} | Approved Amount: {objInrFormatter.format(Number(objItem.decApprovedAmount || 0))} | Proof: {strProofSummaryStatus}
        </Typography>
        <Stack direction="row" alignItems="center" spacing={0.6}>
          <Typography sx={{ fontSize: "0.78rem", color: "#475569", fontWeight: 700 }}>
            Uploaded Proofs ({lstProofs.length})
          </Typography>
