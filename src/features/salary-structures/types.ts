...
export type SalaryStructureLineFormValue = {
  ...
  strPayslipSectionSnapshotCode: string;
  intLwpTreatmentSnapshotID: number | "";
  strLwpTreatmentSnapshotCode: string;
  strLwpTreatment: string;
  intLwpReducedAmountHandlingSnapshotID: number | "";
  strLwpReducedAmountHandlingSnapshotCode: string;
  strLwpReducedAmountHandling: string;
  strLwpProrationFormulaSnapshot: string;
