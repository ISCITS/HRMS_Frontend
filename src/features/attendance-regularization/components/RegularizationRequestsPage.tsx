...
export default function RegularizationRequestsPage() {
  ...
  const [objOnBehalf, setObjOnBehalf] = useState<RegularizationFormValues & { intEmployeeID: number | null; strOnBehalfReason: string }>({
