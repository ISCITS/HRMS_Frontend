...
type EmployeeAllocationPanelProps = {
...
export default function EmployeeAllocationPanel({ intEmployeeSalaryComponentID }: EmployeeAllocationPanelProps) {
  ...
  }, [objAccess.blnLoading, intEmployeeSalaryComponentID]);
  ...
  return (
    <Stack spacing={2} sx={{ p: 2 }}>
      ...
      <Stack direction="row" alignItems="center" justifyContent="space-between" flexWrap="wrap" gap={1}>
        ...
        <Button
          data-control-id="employee-allocation.header.back.button"
      ...
      <Paper sx={{ p: 2 }}>
        <Box sx={{ display: "flex", flexWrap: "wrap", gap: 1.5 }}>
          <Chip
            label={`${t("employee_salary_component", "Employee Salary Component")}: ${intEmployeeSalaryComponentID}`}
          />
      ...
      <Paper sx={{ p: 2 }}>
        <Stack direction="row" justifyContent="space-between" alignItems="center" flexWrap="wrap" gap={1} sx={{ mb: 1.5 }}>
          <Typography variant="h6">{t("allocation_grid", "Allocation Split")}</Typography>
