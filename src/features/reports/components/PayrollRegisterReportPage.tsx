      ...
      <Box className={styles.controlsCard}>
        ...
        <Box className={styles.reportSearchPanelRow}>
          <Box className={styles.reportSearchField}>
            <ReportMultiSelectField label="Employee" value={dicSearchDraft.strSearchEmployee} onChange={(strValue) => setDicSearchDraft((dicPrevious) => ({ ...dicPrevious, strSearchEmployee: strValue }))} options={dicFilterOptions.lstEmployees} placeholder="Search by employee code or name" controlId="reports.payroll-register.employee-search.input" />
          </Box>
          <Box className={styles.reportSearchField}>
            <ReportMultiSelectField label="Payroll Period / Run" value={dicSearchDraft.strSearchRun} onChange={(strValue) => setDicSearchDraft((dicPrevious) => ({ ...dicPrevious, strSearchRun: strValue }))} options={dicFilterOptions.lstRuns} placeholder="Payroll period or run" controlId="reports.payroll-register.run-search.input" />
          </Box>
          <Box className={styles.reportSearchField}>
          ...
          <Box className={styles.reportSearchField}>
            <ReportMultiSelectField label="Department" value={dicSearchDraft.strDepartment} onChange={(strValue) => setDicSearchDraft((dicPrevious) => ({ ...dicPrevious, strDepartment: strValue }))} options={dicFilterOptions.lstDepartments} placeholder="Department" controlId="reports.payroll-register.department.input" />
          </Box>
          <Box className={styles.reportSearchField}>
            <ReportMultiSelectField label="Location" value={dicSearchDraft.strLocation} onChange={(strValue) => setDicSearchDraft((dicPrevious) => ({ ...dicPrevious, strLocation: strValue }))} options={dicFilterOptions.lstLocations} placeholder="Location" controlId="reports.payroll-register.location.input" />
          </Box>
          <Box className={styles.reportSearchField}>
