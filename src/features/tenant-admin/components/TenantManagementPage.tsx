      ...
      <Stack spacing={3}>
        ...
        >
          <Stack direction={{ xs: "column", lg: "row" }} spacing={2}>
            <TextField label="Search tenant" value={strSearch} onChange={(e) => setStrSearch(e.target.value)} fullWidth />
            <TextField select label="Status" value={strStatus} onChange={(e) => setStrStatus(e.target.value)} sx={{ minWidth: 180 }}>
              <MenuItem value="">All</MenuItem>
              <MenuItem value="active">Active</MenuItem>
              <MenuItem value="inactive">Inactive</MenuItem>
            </TextField>
            <TextField select label="Sort" value={strSort} onChange={(e) => setStrSort(e.target.value)} sx={{ minWidth: 220 }}>
