    ...
    <Stack spacing={1.5}>
      <Paper sx={{ p: 2, borderRadius: 3 }}>
        <Stack direction={{ xs: "column", md: "row" }} spacing={1.5} alignItems={{ md: "center" }}>
          ...
          <Box sx={{ flex: 1 }}><Typography variant="h5" fontWeight={800}>{t("page_title", "Holiday & Leave Calendar")}</Typography><Typography color="text.secondary">{t("subtitle", "Your holidays, leave, attendance and weekly offs.")}</Typography></Box>
