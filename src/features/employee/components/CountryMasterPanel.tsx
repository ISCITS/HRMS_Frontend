...
export default function CountryMasterPanel() {
  ...
  const dicModuleLabels = {
    breadcrumbs: t("breadcrumbs", "Admin / Master / Countries"),
    pageTitle: t("page_title", dicConstant.countries.pageTitle),
    backButton: t("back_button", dicConstant.countries.backButton),
    addButton: t("add_button", dicConstant.countries.addButton),
    searchNamePlaceholder: t("search_name_placeholder", "Search Country Name"),
    searchCodePlaceholder: t("search_code_placeholder", "Search Country Code"),
    searchStatusPlaceholder: t("search_status_placeholder", "Status"),
    tableName: t("table_name", "Country Name"),
    tableCode: t("table_code", "Country Code"),
    tableCurrency: t("table_currency", "Currency"),
    tablePhoneCode: t("table_phone_code", "Phone Code"),
    tableStatus: t("table_status", "Status"),
    tableActions: t("table_actions", "Actions"),
    loadingRecords: t("loading_records", "Loading countries..."),
    emptyMessage: t("empty_message", "No country records found."),
    dialogAddTitle: t("dialog_add_title", dicConstant.countries.dialogAddTitle),
    dialogEditTitle: t("dialog_edit_title", dicConstant.countries.dialogEditTitle),
    dialogViewTitle: t("dialog_view_title", "View Country"),
  };
