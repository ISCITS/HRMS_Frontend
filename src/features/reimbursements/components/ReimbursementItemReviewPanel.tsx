      ...
      <Grid container spacing={2}>
        ...
        <Grid item xs={12} md={3}>
          <Stack spacing={1} alignItems={{ xs: "flex-start", md: "flex-end" }} sx={{ mr: { xs: 0, md: 1 } }}>
            ...
            <Box sx={{ width: "100%" }}>
              <ReimbursementProofViewer strClaimRecordUUID={strClaimRecordUUID} lstProofs={objItem.lstProofs} blnActionsDisabled={blnActionsDisabled || !blnCanProofReview} onVerify={onVerifyProof} onReject={onRejectProof} />
            </Box>
          </Stack>
        </Grid>
        <Grid item xs={12}>
