    ...
    <Stack spacing={3}>
      ...
      <Paper sx={{ p: { xs: 2, md: 3 } }}>
        ...
        <Box sx={{ display: "flex", justifyContent: "space-between", gap: 2, mt: 4 }}>
          <Button controlId="tenant.onboarding.previous.button" variant="outlined" onClick={handleBack} disabled={intActiveStep === 0 || blnSubmitting}>Previous</Button>
          {intActiveStep < 2 ? (
            <Button
              controlId="tenant.onboarding.next.button"
              variant="contained"
              onClick={handleNext}
            ...
            <Button
              controlId="tenant.onboarding.create.button"
              variant="contained"
    ...
    return (
      <Stack spacing={2.5}>
        ...
        <Box sx={{ display: "grid", gridTemplateColumns: { xs: "1fr", md: "1fr 1fr" }, gap: 2 }}>
          ...
          <TextField controlId="tenant.onboarding.auth.mfa-flag.select" inputProps={{ "controlId": "tenant.onboarding.auth.mfa-flag.select" }} select label="MFA Flag *" value={objForm.auth.intMfaFlagID === "" ? "" : String(objForm.auth.intMfaFlagID)} onChange={(e) => setField("auth.intMfaFlagID", e.target.value ? Number(e.target.value) : "")} error={Boolean(dicErrors["auth.intMfaFlagID"])} helperText={dicErrors["auth.intMfaFlagID"]} fullWidth>
          ...
          {blnShowMfaType ? (
            <TextField controlId="tenant.onboarding.auth.mfa-type.select" inputProps={{ "controlId": "tenant.onboarding.auth.mfa-type.select" }} select label="MFA Type *" value={objForm.auth.intMfaTypeID === "" ? "" : String(objForm.auth.intMfaTypeID)} onChange={(e) => setField("auth.intMfaTypeID", e.target.value ? Number(e.target.value) : "")} error={Boolean(dicErrors["auth.intMfaTypeID"])} helperText={dicErrors["auth.intMfaTypeID"]} fullWidth>
        ...
        {blnShowSsoSection ? (
          <Paper variant="outlined" sx={{ p: 2.5 }}>
            <Stack spacing={2}>
              ...
              <Box sx={{ display: "grid", gridTemplateColumns: { xs: "1fr", md: "1fr 1fr" }, gap: 2 }}>
                <TextField controlId="tenant.onboarding.auth.provider-type.select" inputProps={{ "controlId": "tenant.onboarding.auth.provider-type.select" }} select label="Provider Type *" value={objForm.auth.sso.strProviderType} onChange={(e) => setField("auth.sso.strProviderType", e.target.value)} fullWidth>
                ...
                <TextField controlId="tenant.onboarding.auth.provider-name.input" inputProps={{ "controlId": "tenant.onboarding.auth.provider-name.input" }} label="Provider Name *" value={objForm.auth.sso.strProviderName} onChange={(e) => setField("auth.sso.strProviderName", e.target.value)} error={Boolean(dicErrors["auth.sso.strProviderName"])} helperText={dicErrors["auth.sso.strProviderName"]} fullWidth />
                <TextField controlId="tenant.onboarding.auth.issuer.input" inputProps={{ "controlId": "tenant.onboarding.auth.issuer.input" }} label="Issuer" value={objForm.auth.sso.strIssuer} onChange={(e) => setField("auth.sso.strIssuer", e.target.value)} fullWidth />
                <TextField controlId="tenant.onboarding.auth.client-id.input" inputProps={{ "controlId": "tenant.onboarding.auth.client-id.input" }} label="Client ID *" value={objForm.auth.sso.strClientID} onChange={(e) => setField("auth.sso.strClientID", e.target.value)} error={Boolean(dicErrors["auth.sso.strClientID"])} helperText={dicErrors["auth.sso.strClientID"]} fullWidth />
                <TextField controlId="tenant.onboarding.auth.client-secret.input" inputProps={{ "controlId": "tenant.onboarding.auth.client-secret.input" }} type="password" label="Client Secret *" value={objForm.auth.sso.strClientSecret} onChange={(e) => setField("auth.sso.strClientSecret", e.target.value)} error={Boolean(dicErrors["auth.sso.strClientSecret"])} helperText={dicErrors["auth.sso.strClientSecret"]} fullWidth />
                <TextField controlId="tenant.onboarding.auth.authorization-endpoint.input" inputProps={{ "controlId": "tenant.onboarding.auth.authorization-endpoint.input" }} label="Authorization Endpoint *" value={objForm.auth.sso.strAuthorizationEndpoint} onChange={(e) => setField("auth.sso.strAuthorizationEndpoint", e.target.value)} error={Boolean(dicErrors["auth.sso.strAuthorizationEndpoint"])} helperText={dicErrors["auth.sso.strAuthorizationEndpoint"]} fullWidth />
                <TextField controlId="tenant.onboarding.auth.token-endpoint.input" inputProps={{ "controlId": "tenant.onboarding.auth.token-endpoint.input" }} label="Token Endpoint *" value={objForm.auth.sso.strTokenEndpoint} onChange={(e) => setField("auth.sso.strTokenEndpoint", e.target.value)} error={Boolean(dicErrors["auth.sso.strTokenEndpoint"])} helperText={dicErrors["auth.sso.strTokenEndpoint"]} fullWidth />
                <TextField controlId="tenant.onboarding.auth.jwks-uri.input" inputProps={{ "controlId": "tenant.onboarding.auth.jwks-uri.input" }} label="JWKS URI" value={objForm.auth.sso.strJwksUri} onChange={(e) => setField("auth.sso.strJwksUri", e.target.value)} fullWidth />
                <TextField controlId="tenant.onboarding.auth.redirect-uri.input" inputProps={{ "controlId": "tenant.onboarding.auth.redirect-uri.input" }} label="Redirect URI *" value={objForm.auth.sso.strSsoRedirectUrl} onChange={(e) => setField("auth.sso.strSsoRedirectUrl", e.target.value)} error={Boolean(dicErrors["auth.sso.strSsoRedirectUrl"])} helperText={dicErrors["auth.sso.strSsoRedirectUrl"]} fullWidth />
                <TextField controlId="tenant.onboarding.auth.sso-entry-point.input" inputProps={{ "controlId": "tenant.onboarding.auth.sso-entry-point.input" }} label="SSO Entry Point" value={objForm.auth.sso.strSsoEntryPoint} onChange={(e) => setField("auth.sso.strSsoEntryPoint", e.target.value)} fullWidth />
                <TextField controlId="tenant.onboarding.auth.single-logout-endpoint.input" inputProps={{ "controlId": "tenant.onboarding.auth.single-logout-endpoint.input" }} label="Single Logout Endpoint" value={objForm.auth.sso.strSloEndpoint} onChange={(e) => setField("auth.sso.strSloEndpoint", e.target.value)} fullWidth />
              </Box>
            </Stack>
          </Paper>
        ) : null}
        ...
        {blnShowEmailProviderSection ? (
          <Paper variant="outlined" sx={{ p: 2.5 }}>
            <Stack spacing={2}>
              ...
              <Box sx={{ display: "grid", gridTemplateColumns: { xs: "1fr", md: "1fr 1fr" }, gap: 2 }}>
                <TextField controlId="tenant.onboarding.auth.sender-email.input" inputProps={{ "controlId": "tenant.onboarding.auth.sender-email.input" }} label="Sender Email *" value={objForm.auth.email.strSmtpSenderEmail} onChange={(e) => setField("auth.email.strSmtpSenderEmail", e.target.value)} error={Boolean(dicErrors["auth.email.strSmtpSenderEmail"])} helperText={dicErrors["auth.email.strSmtpSenderEmail"]} fullWidth />
                <TextField controlId="tenant.onboarding.auth.smtp-username.input" inputProps={{ "controlId": "tenant.onboarding.auth.smtp-username.input" }} label="SMTP Username *" value={objForm.auth.email.strSmtpUsername} onChange={(e) => setField("auth.email.strSmtpUsername", e.target.value)} error={Boolean(dicErrors["auth.email.strSmtpUsername"])} helperText={dicErrors["auth.email.strSmtpUsername"]} fullWidth />
                <TextField controlId="tenant.onboarding.auth.smtp-password.input" inputProps={{ "controlId": "tenant.onboarding.auth.smtp-password.input" }} type="password" label="SMTP Password *" value={objForm.auth.email.strSmtpPassword} onChange={(e) => setField("auth.email.strSmtpPassword", e.target.value)} error={Boolean(dicErrors["auth.email.strSmtpPassword"])} helperText={dicErrors["auth.email.strSmtpPassword"]} fullWidth />
                <TextField controlId="tenant.onboarding.auth.smtp-server.input" inputProps={{ "controlId": "tenant.onboarding.auth.smtp-server.input" }} label="SMTP Server *" value={objForm.auth.email.strSmtpServer} onChange={(e) => setField("auth.email.strSmtpServer", e.target.value)} error={Boolean(dicErrors["auth.email.strSmtpServer"])} helperText={dicErrors["auth.email.strSmtpServer"]} fullWidth />
                <TextField controlId="tenant.onboarding.auth.smtp-port.input" inputProps={{ "controlId": "tenant.onboarding.auth.smtp-port.input" }} label="SMTP Port *" value={objForm.auth.email.intSmtpPort} onChange={(e) => setField("auth.email.intSmtpPort", e.target.value.replace(/\D/g, ""))} error={Boolean(dicErrors["auth.email.intSmtpPort"])} helperText={dicErrors["auth.email.intSmtpPort"]} fullWidth />
                <TextField controlId="tenant.onboarding.auth.bcc-email.input" inputProps={{ "controlId": "tenant.onboarding.auth.bcc-email.input" }} label="BCC Email" value={objForm.auth.email.strSmtpBccEmail} onChange={(e) => setField("auth.email.strSmtpBccEmail", e.target.value)} error={Boolean(dicErrors["auth.email.strSmtpBccEmail"])} helperText={dicErrors["auth.email.strSmtpBccEmail"]} fullWidth />
              </Box>
            </Stack>
          </Paper>
        ) : null}
  ...
  function renderDatastoreConfiguration() {
    return (
      <Stack spacing={2.25}>
        ...
        <FormControlLabel
          control={<Checkbox checked={objForm.datastore.blnUseExistingDatabase} onChange={(_, blnChecked) => setField("datastore.blnUseExistingDatabase", blnChecked)} inputProps={{ "controlId": "tenant.onboarding.datastore.use-existing-database.checkbox" } as InputHTMLAttributes<HTMLInputElement>} />}
          label="Use Existing Database"
        />
        <Box sx={{ display: "grid", gridTemplateColumns: { xs: "1fr", md: "1fr 1fr" }, gap: 2 }}>
          <TextField controlId="tenant.onboarding.datastore.datastore-type.select" inputProps={{ "controlId": "tenant.onboarding.datastore.datastore-type.select" }} select label="Datastore Type *" value={objForm.datastore.strStoreType} onChange={(e) => setField("datastore.strStoreType", e.target.value)} fullWidth>
          ...
          <TextField controlId="tenant.onboarding.datastore.database-type.select" inputProps={{ "controlId": "tenant.onboarding.datastore.database-type.select" }} select label="Database Type *" value={objForm.datastore.strDatabaseType} onChange={(e) => setField("datastore.strDatabaseType", e.target.value)} fullWidth>
            <MenuItem value="postgresql">PostgreSQL</MenuItem>
          </TextField>
          <TextField controlId="tenant.onboarding.datastore.database-name.input" inputProps={{ "controlId": "tenant.onboarding.datastore.database-name.input" }} label="Database Name *" value={objForm.datastore.strDatabaseName} onChange={(e) => setField("datastore.strDatabaseName", e.target.value)} error={Boolean(dicErrors["datastore.strDatabaseName"])} helperText={dicErrors["datastore.strDatabaseName"]} fullWidth />
          <TextField controlId="tenant.onboarding.datastore.schema-name.input" inputProps={{ "controlId": "tenant.onboarding.datastore.schema-name.input" }} label="Schema Name" value={objForm.datastore.strSchemaName} onChange={(e) => setField("datastore.strSchemaName", e.target.value)} error={Boolean(dicErrors["datastore.strSchemaName"])} helperText={dicErrors["datastore.strSchemaName"]} fullWidth />
          <TextField controlId="tenant.onboarding.datastore.database-host.input" inputProps={{ "controlId": "tenant.onboarding.datastore.database-host.input" }} label="Database Host / Server *" value={objForm.datastore.strDbHost} onChange={(e) => setField("datastore.strDbHost", e.target.value)} error={Boolean(dicErrors["datastore.strDbHost"])} helperText={dicErrors["datastore.strDbHost"]} fullWidth />
          <TextField controlId="tenant.onboarding.datastore.port.input" inputProps={{ "controlId": "tenant.onboarding.datastore.port.input" }} label="Port *" value={objForm.datastore.intDbPort} onChange={(e) => setField("datastore.intDbPort", e.target.value.replace(/\D/g, ""))} error={Boolean(dicErrors["datastore.intDbPort"])} helperText={dicErrors["datastore.intDbPort"]} fullWidth />
          <TextField controlId="tenant.onboarding.datastore.database-username.input" inputProps={{ "controlId": "tenant.onboarding.datastore.database-username.input" }} label="Database Username *" value={objForm.datastore.strDbUserName} onChange={(e) => setField("datastore.strDbUserName", e.target.value)} error={Boolean(dicErrors["datastore.strDbUserName"])} helperText={dicErrors["datastore.strDbUserName"]} fullWidth />
          <TextField controlId="tenant.onboarding.datastore.database-password.input" inputProps={{ "controlId": "tenant.onboarding.datastore.database-password.input" }} type="password" label="Database Password *" value={objForm.datastore.strDbPassword} onChange={(e) => setField("datastore.strDbPassword", e.target.value)} error={Boolean(dicErrors["datastore.strDbPassword"])} helperText={dicErrors["datastore.strDbPassword"]} fullWidth />
        </Box>
        {objForm.datastore.blnUseExistingDatabase ? (
          <Stack spacing={2}>
            <Box sx={{ display: "flex", justifyContent: "flex-end" }}>
              <Button
                controlId="tenant.onboarding.datastore.validate-database.button"
                variant="outlined"
    ...
    return (
      <Paper variant="outlined" sx={{ p: 2.5 }}>
        <Stack spacing={2}>
          ...
          <Box sx={{ display: "grid", gridTemplateColumns: { xs: "1fr", md: "1fr 1fr" }, gap: 2 }}>
            <TextField controlId="tenant.onboarding.initial-admin.full-name.input" inputProps={{ "controlId": "tenant.onboarding.initial-admin.full-name.input" }} label="Full Name *" value={objForm.initialAdmin.strFullName} onChange={(e) => setField("initialAdmin.strFullName", e.target.value)} error={Boolean(dicErrors["initialAdmin.strFullName"])} helperText={dicErrors["initialAdmin.strFullName"]} fullWidth />
            <TextField controlId="tenant.onboarding.initial-admin.login-id.input" inputProps={{ "controlId": "tenant.onboarding.initial-admin.login-id.input" }} label="Login ID / Username *" value={objForm.initialAdmin.strLoginID} onChange={(e) => setField("initialAdmin.strLoginID", e.target.value)} error={Boolean(dicErrors["initialAdmin.strLoginID"])} helperText={dicErrors["initialAdmin.strLoginID"]} fullWidth />
            <TextField controlId="tenant.onboarding.initial-admin.email.input" inputProps={{ "controlId": "tenant.onboarding.initial-admin.email.input" }} label="Email *" value={objForm.initialAdmin.strEmailAddress} onChange={(e) => setField("initialAdmin.strEmailAddress", e.target.value)} error={Boolean(dicErrors["initialAdmin.strEmailAddress"])} helperText={dicErrors["initialAdmin.strEmailAddress"]} fullWidth />
            <TextField controlId="tenant.onboarding.initial-admin.mobile-number.input" inputProps={{ "controlId": "tenant.onboarding.initial-admin.mobile-number.input" }} label="Mobile Number" value={objForm.initialAdmin.strMobileNumber} onChange={(e) => setField("initialAdmin.strMobileNumber", e.target.value)} error={Boolean(dicErrors["initialAdmin.strMobileNumber"])} helperText={dicErrors["initialAdmin.strMobileNumber"]} fullWidth />
            <TextField controlId="tenant.onboarding.initial-admin.password.input" inputProps={{ "controlId": "tenant.onboarding.initial-admin.password.input" }} type="password" label="Password *" value={objForm.initialAdmin.strPassword} onChange={(e) => setField("initialAdmin.strPassword", e.target.value)} error={Boolean(dicErrors["initialAdmin.strPassword"])} helperText={dicErrors["initialAdmin.strPassword"]} fullWidth />
            <TextField controlId="tenant.onboarding.initial-admin.confirm-password.input" inputProps={{ "controlId": "tenant.onboarding.initial-admin.confirm-password.input" }} type="password" label="Confirm Password *" value={objForm.initialAdmin.strConfirmPassword} onChange={(e) => setField("initialAdmin.strConfirmPassword", e.target.value)} error={Boolean(dicErrors["initialAdmin.strConfirmPassword"])} helperText={dicErrors["initialAdmin.strConfirmPassword"]} fullWidth />
          </Box>
        </Stack>
      </Paper>
    );
