    ...
    <Box sx={{ minHeight: "100vh", display: "grid", placeItems: "center", p: 3, background: "#f8fafc" }}>
      <Paper sx={{ maxWidth: 620, width: "100%", p: 4, borderRadius: "28px" }}>
        <Stack spacing={3}>
          ...
          <Stack spacing={2}>
            {blnAllowBackupCode ? (
              <Button data-controlid={toggleBackupCodeButtonTestId} variant="text" onClick={onToggleBackupCode} startIcon={<VpnKeyRoundedIcon />}>
            ...
            {blnUseBackupCode ? (
              <TextField
                label="Backup code"
                inputProps={{ "data-controlid": backupCodeInputTestId }}
                value={strBackupCode}
              ...
              <TextField
                ...
                inputProps={{ "data-controlid": codeInputTestId }}
                value={strCode}
            ...
            <Button
              data-controlid={verifyButtonTestId}
              variant="contained"
