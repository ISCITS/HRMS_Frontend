...
import PayrollKpiCard from "@/components/payroll/PayrollKpiCard";
      ...
      >
        <Grid item xs={12} sm={6} md={3}>
          <PayrollKpiCard
            ...
            lstTrendPoints={[56, 58, 57, 61, 63, 66, 69]}
          />
        </Grid>
        <Grid item xs={12} sm={6} md={3}>
          <PayrollKpiCard
            ...
            strTrend="+3.8% MoM"
            strTrendTone="positive"
            lstTrendPoints={[49, 51, 53, 52, 56, 58, 60]}
          />
        </Grid>
        <Grid item xs={12} sm={6} md={3}>
          <PayrollKpiCard
        ...
        <Grid item xs={12} sm={6} md={3}>
          <PayrollKpiCard
            ...
            lstTrendPoints={[74, 78, 80, 84, 88, 91, 94]}
          />
        </Grid>
      </Grid>
